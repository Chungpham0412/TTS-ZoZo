          ...
          <div class="pagination" style="text-align: center;display: block;">
           <?php 
            ...
            $k = (($current_page+2>$total_page)?$total_page-2:(($current_page-2<1)?3:$current_page));
             ...
             $pagLink = "";
           if ($current_page >=2){
             echo "<li><a href='test.php?page=1'> << </a></li>"; 
              echo "<li><a href='test.php?page=".($current_page-1)."'> < </a></li>"; 
          }
            // Lặp khoảng giữa
          for ($i = -2; $i <= 2; $i++){
            ...
            if ($k+$i == $current_page){
              $pagLink .= "<li class='active'><a href='test.php?page=".($k+$i)."'>".($k+$i)."</a></li>"; 

            }
            else{
             $pagLink .= "<li><a href='test.php?page=".($k+$i)."'>".($k+$i)."</a></li>";   
            }
          }
            echo $pagLink; 
            if($current_page<$total_page){ 
                echo "<li><a href='test.php?page=".($current_page+1)."'> > </a></li>"; 
                echo "<li><a href='test.php?page=".$total_page."'> >> </a></li>"; 
            }     
          ?>
        </div>
        </div>
