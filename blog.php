			...
			<section class="page-top-md">
				<div class="container">
					<div class="page-top-in">
						<h2><span>Blog mini - side bar</span></h2>
					</div>
				</div>
			</section>
			<!-- End page top -->
								...
								<div class="row">
									<div class="col-xs-4">
										<div class="post-image single">
											...
											<a href="blog-single.html"><img class="img-responsive" src="public/images/content/blog/demo-m-6.jpg" alt="Blog"></a>
										</div>
									</div>
									<div class="col-xs-8">
									...
									<div class="col-xs-4">
										<div class="post-image">
											<div id="owl-blog-slide" class="owl-carousel owl-theme">
												<div class="item">
													<img class="img-responsive" src="public/images/content/blog/demo-m-3.jpg" alt="Blog">
												</div>
												<div class="item">
													<img class="img-responsive" src="public/images/content/blog/demo-m-4.jpg" alt="Blog">
												</div>
												<div class="item">
													<img class="img-responsive" src="public/images/content/blog/demo-m-5.jpg" alt="Blog">
												</div>
											</div>
								...
								<div class="row">
									<div class="col-xs-4">
										<div class="post-video vimeo">
											<iframe src="http://player.vimeo.com/video/28614006?color=0088CC" width="100%" height="270" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""></iframe>
										</div>
									</div>
									<div class="col-xs-8">
								...
								<div class="row">
									<div class="col-xs-4">
										<div class="post-image single">
											...
											<a href="blog-single.html"><img class="img-responsive" src="public/images/content/blog/demo-m-7.jpg" alt="Blog"></a>
										</div>
									</div>
									<div class="col-xs-8">
					...
					<div class="col-md-3">
						<aside class="sidebar">
							...
							<aside class="block blk-ads">
								<h4>Ads</h4>
								<img class="img-responsive" src="public/images/content/blog/side-ad.png" alt="Blog">
							</aside>
								...
								<div class="tab-content">
									<div class="tab-pane active" id="popularPosts">
										<ul class="list-unstyled simple-post-list">
											<li>
												<div class="post-image">
													<a href="blog-single.html"><img class="img-responsive" src="public/images/content/blog/demo-thumb-7.jpg" alt="Blog"></a>
												</div>
												<div class="post-info">
											...
											<li>
												<div class="post-image">
													<a href="blog-single.html"><img class="img-responsive" src="public/images/content/blog/demo-thumb-6.jpg" alt="Blog"></a>
												</div>
												<div class="post-info">
											...
											<li>
												<div class="post-image">
													<a href="blog-single.html"><img class="img-responsive" src="public/images/content/blog/demo-thumb-5.jpg" alt="Blog"></a>
												</div>
												<div class="post-info">
											...
											<li>
												<div class="post-image">
													<a href="blog-single.html"><img class="img-responsive" src="public/images/content/blog/demo-thumb-4.jpg" alt="Blog"></a>
												</div>
												<div class="post-info">
											...
											<li>
												<div class="post-image">
													<a href="blog-single.html"><img class="img-responsive" src="public/images/content/blog/demo-thumb-3.jpg" alt="Blog"></a>
												</div>
												<div class="post-info">
									...
									<div class="tab-pane" id="latestPosts">
										<ul class="list-unstyled simple-post-list">
											...
											<li>
												<div class="post-image">
													<a href="blog-single.html"><img class="img-responsive" src="public/images/content/blog/demo-thumb-1.jpg" alt="Blog"></a>
												</div>
												<div class="post-info">
													<a href="blog-single.html">Sed ut perspiciatis unde omnis iste natus error sit</a>
													<div class="post-meta">
							...
							<aside class="block blk-ads">
								...
								<ul class="list-thumb-gallery">
									<li><a href="#"><img class="img-responsive" src="public/images/content/blog/demo-thumb-1.jpg" alt="Photo"></a></li>
									<li><a href="#"><img class="img-responsive" src="public/images/content/blog/demo-thumb-2.jpg" alt="Photo"></a></li>
									<li><a href="#"><img class="img-responsive" src="public/images/content/blog/demo-thumb-3.jpg" alt="Photo"></a></li>
									<li><a href="#"><img class="img-responsive" src="public/images/content/blog/demo-thumb-4.jpg" alt="Photo"></a></li>
									<li><a href="#"><img class="img-responsive" src="public/images/content/blog/demo-thumb-5.jpg" alt="Photo"></a></li>
									<li><a href="#"><img class="img-responsive" src="public/images/content/blog/demo-thumb-6.jpg" alt="Photo"></a></li>
								</ul>
							</aside>
						</aside>
					</div>
